...
static const int TERRITORY_W = 118;
static const int PIECE_W = 760;
static const int THREATENED_W = 165;
static const int PREY_W = 82;
...
static const int PROX_FAR_W = 22;
static const int PROX_NEAR_W = 42;
static const int LATE_TERR_W = 4;
